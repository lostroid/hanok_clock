...
최근 ESP 말고 STM32WBA65 시리즈를 찾음  
Cortex-M33 계열에 100 Mhz 속도로 무선 통합 가능성 테스트  
자주 사용하는 ST 계열 (여담 이지만 전엔 ATEML, PIC, ST  개발 툴 비용이 저렴하며  
B2B 가 아닌 일반 인에게 데이터시트 공개 접근성이 좋아서 현재 위치가 된 거 같음  
...
1. 주 목적은 무선 통신 학습  (STM32WBA65 시리즈)  
   ...
   - 통신 클래스 구조 파악   
   - Zigbee 2차 목표   
2. 하나의 기능 보단 하나의 제품의 유기적인 데이터 처리  
   - Bare Metal 시스템 개발 목적.  
...
스피커에 비에 사양이 오버이긴 합니다 5W 스피커에 비하면  
